...
import 'package:ytel/ytel/screens/contact/view/create_contact.dart';
import 'package:ytel/ytel/screens/contact/view/edit_contact.dart';
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(snapshot.data!['payload'][index]['extData']
                                        ['phonenumber1']
                                    .toString()),
                                Expanded(
                                    child: Align(
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        Get.to(EditContact(snapshot: snapshot.data!['payload'][index]));
                                      },
                                      child: Icon(
                                        IconHelper.icons[11],
                                        color: ColorHelper.colors[7],
