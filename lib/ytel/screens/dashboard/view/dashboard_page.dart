...
import '../../reporting/logs/view/log_view.dart';
import '../../setting_asset/view/setting_asset_view.dart';
            ...
            child: Row(
              children: [
                ...
                container_rounded(
                    ...
                    Icon(
                      IconHelper.icons[16],
                      color: ColorHelper.colors[4],
                      size: 44,
                    ),
                    ColorHelper.colors[4]),
                SizedBox(
                  width: 20,
                ),
              ],
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                      ...
                      children: [
                        ...
                        Center(
                          child: Text(
                            userName,
                            style: TextStyle(
                                color: ColorHelper.colors[8], fontSize: 24),
                          ),
                        )
                      ],
                    )),
              ...
              _commonTile(
                  "Dashboard", const HomeScreen(), 'assets/images/25.png'),
              _commonTile("Inbox", ChatsPage(), "assets/images/15.png"),
              _commonMethod("assets/images/8.png", "Contacts", [
              ...
              _commonMethod("assets/images/27.png", "Workflow", [
              ...
              _commonMethod("assets/images/13.png", "Numbers", [
              ...
              _commonMethod("assets/images/6.png", "Reporting", [
                _commonListTile("Usage", const UnderDevelopment()),
                _commonListTile("Logs", const LogViewPage()),
              ...
              _commonMethod("assets/images/29.png", "Settings", [
              ...
              _commonTile("Contact Center", const UnderDevelopment(),
                  "assets/images/9.png"),
              _commonTile(
                  "UCaaS", const UnderDevelopment(), "assets/images/30.png"),
              _commonTile("Add Feature", const UnderDevelopment(),
                  "assets/images/25.png"),
              Divider(),
              _commonMethod("assets/images/41.png", userName, [
                _commonListTile("Profile", const UnderDevelopment()),
                _commonListTile("Logout", LogoutDialog()),
              ]),
              _commonMethod("assets/images/16.png", "Help", [
