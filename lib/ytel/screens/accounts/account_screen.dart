...
// import '../auth/controller/user_view_accounts_controller.dart';
...
//     child: FutureBuilder(
//       future: user_view_accounts_controller.data(),
...
//                                 child: InkWell(
//                                     onTap: (){
//                                       // user_view_controller.first_name.text = "${snapshot.data![index.toInt()]["name"]}";
//                                       // user_view_controller.email.text = "${snapshot.data![index.toInt()]["emailAddress"]}";
//                                       // user_view_controller.web_phone.text = "${snapshot.data![index.toInt()]["phone"]}";
